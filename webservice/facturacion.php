<html>
	...
	<body>
		...
		$nit_ci=$_GET['nit_ci'];
		$fecha=$_GET['fecha']; //formato aceptado AAAAMMDD
		$monto=$_GET['monto'];
		$llave=$_GET['llave'];
		$nroAutorizacion=$_GET['nroAutorizacion'];
		
		$funcion = 'generarCodigo';
		$codigo=$funcion($nroFactura,$nit_ci,$fecha,$monto,$llave,$nroAutorizacion);   
		echo "{codigo_control : $codigo}";
